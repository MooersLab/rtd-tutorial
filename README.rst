...
Log in to your Read-the-docs account.
...
best to prepare the bulk of the document in an editor
that is configured for handling ReStructuredText files. 
Otherwise, you will get a lot of practice cycling 
...
- Click on 'Create pull request'. A yellow message appears about a check-in in progress.
...
The backslashes have to be escaped, and the double $$ removed.
